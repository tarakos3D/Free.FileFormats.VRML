...
{
	public class x3dVolumePickSensor : X3DNode, X3DPickSensorNode
	{
		...
		internal override X3DPrototypeInstance GetProto() { return new x3dVolumePickSensorPROTO(); }
		...
		internal override bool ParseNodeBodyElement(string id, VRMLParser parser)
		{
			...
			else if(id=="pickingGeometry")
			{
				...
				if(node!=null)
				{
					PickingGeometry=node as X3DGeometryNode;
