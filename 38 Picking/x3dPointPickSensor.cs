...
{
	public class x3dPointPickSensor : X3DNode, X3DPickSensorNode
	{
		...
		internal override X3DPrototypeInstance GetProto() { return new x3dPointPickSensorPROTO(); }
