...
{
	public class x3dLinePickSensor : X3DNode, X3DPickSensorNode
	{
		...
		internal override X3DPrototypeInstance GetProto() { return new x3dLinePickSensorPROTO(); }
