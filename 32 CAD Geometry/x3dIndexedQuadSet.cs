...
{
	public class x3dIndexedQuadSet : X3DNode, X3DComposedGeometryNode
	{
		...
		internal override X3DPrototypeInstance GetProto() { return new x3dIndexedQuadSetPROTO(); }
