...
namespace Free.FileFormats.VRML.Nodes
{
	public class x3dScreenGround : X3DNode, X3DGroupingNode
	{
		...
		internal override X3DPrototypeInstance GetProto() { return new x3dScreenGroundPROTO(); }
