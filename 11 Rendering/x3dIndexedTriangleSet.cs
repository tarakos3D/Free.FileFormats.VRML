...
namespace Free.FileFormats.VRML.Nodes
{
	...
	/// </summary>
	public class x3dIndexedTriangleSet : X3DNode, X3DComposedGeometryNode
	{
		...
		internal override X3DPrototypeInstance GetProto() { return new x3dIndexedTriangleSetPROTO(); }
