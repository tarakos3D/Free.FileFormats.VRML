...
{
	/// <summary>
	/// An IndexedTriangleFanSet represents a 3D shape composed of triangles that
	/// form a fan shape around the first vertex declared in each fan.
	/// </summary>
	public class x3dIndexedTriangleFanSet : X3DNode, X3DComposedGeometryNode
	{
		...
		public x3dIndexedTriangleFanSet()
		{
		...
		internal override X3DPrototypeInstance GetProto() { return new x3dIndexedTriangleFanSetPROTO(); }
		...
		internal override bool ParseNodeBodyElement(string id, VRMLParser parser)
		{
			...
			else if(id=="index") Index=parser.ParseSFInt32OrMFInt32Value();
			else return false;
			return true;
		}
